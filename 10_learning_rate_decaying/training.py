...
if __name__  == '__main__':
    imgDir = '/home/sijoonlee/Documents/self-driving-course/10_learning_rate_decaying/GTSRB/Final_Training/Images'

    logger = get_module_logger(__name__)
    parser = argparse.ArgumentParser(description='Download and process tf files')
    parser.add_argument('-d', '--imdir', default=imgDir, type=str,
                        help='data directory')
